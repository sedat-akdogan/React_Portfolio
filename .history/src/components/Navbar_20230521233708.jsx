...
const Navbar = () => {
    ...
    return (
        <nav
            className={`${styles.paddingX} w-full h-20flex items-center py-5 fixed top- 
            0 z-50 bg-gray-800}`}
        >
            <div className='absolute inset-y-0 w-full flex justify-between items-center max-w-7xl mx- 
            auto z-50 bg-gray-800'
            >
                <Link
                    to='/'
